<html>
    ...
    <body class="box" style="background-color: #ededed;">
        <div >
            <div style="position: relative; top: 1em; text-align:center; font-weight: bold;">Exclusão de Funcionário</div>
            <div style="position: relative; top: 3em; left: 35em; width: 700px;">
                <b>Funcionário removido com sucesso!</b><br><br>
                <a href="consulta_func.php"><input class="btn btn-success" type="submit" name="gravar" value="Retornar"></a>
