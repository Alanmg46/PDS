<html>
    ...
    <body class="box" style="background-color: #ededed;">
        <div >
            <div style="position: relative; top: 1em; text-align:center; font-weight: bold;">Cadastro de Produto</div>
            <div style="position: relative; top: 3em; left: 35em; width: 700px;">
                <b>Produto cadastrado com sucesso!</b><br>
                <a href="consulta_produto.php"><input class="btn btn-success" type="submit" name="gravar" value="Retornar"></a>
